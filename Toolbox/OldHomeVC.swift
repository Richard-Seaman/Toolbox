...
class OldHomeVC: UIViewController {
    ...
    func getActionViews() -> [ActionView] {
        ...
        ductSizer.button.setImage(UIImage(named: "DuctSizer"), for: UIControlState())
        ductSizer.button.addTarget(self, action: #selector(OldHomeVC.ductButtonTapped), for: UIControlEvents.touchUpInside)
        ...
        pipeSizer.button.setImage(UIImage(named: "PipeSizer"), for: UIControlState())
        pipeSizer.button.addTarget(self, action: #selector(OldHomeVC.pipeSizerButtonTapped), for: UIControlEvents.touchUpInside)
        ...
        networkSizer.button.addTarget(self, action: #selector(OldHomeVC.pipeButtonTapped), for: UIControlEvents.touchUpInside)
        ...
        waterDemand.button.addTarget(self, action: #selector(OldHomeVC.waterButtonTapped), for: UIControlEvents.touchUpInside)
        ...
        daylightCalculator.button.setImage(UIImage(named: "Daylight"), for: UIControlState())
        daylightCalculator.button.addTarget(self, action: #selector(OldHomeVC.daylightButtonTapped), for: UIControlEvents.touchUpInside)
